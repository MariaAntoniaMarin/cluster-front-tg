...
* A file called `src/routes/about.svelte` corresponds to the `/about` route. A file called `src/routes/algorithms/[slug].svelte` corresponds to the `/algorithms/:slug` route, in which case `params.slug` is available to the route
